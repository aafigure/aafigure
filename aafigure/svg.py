...
""")
            ...
            self.file_like.write(u"""<svg width="{}" height="{}" version="1.1" xmlns="http://www.w3.org/2000/svg">\n""".format(
                self._num(self.width),
                self._num(self.height)))
    ...
    def _line(self, x1, y1, x2, y2, thick):
        ...
        self.file_like.write(
            u"""{}<line x1="{}" y1="{}" x2="{}" y2="{}" stroke="{}" stroke-width="{}" />\n""".format(
                self.indent,
                self._num(x1),
                self._num(y1),
                self._num(x2),
    ...
    def _rectangle(self, x1, y1, x2, y2, style=''):
        ...
        if y1 > y2:
            y1, y2 = y2, y1
        self.file_like.write(u"""\
{}<rect x="{}" y="{}" width="{}" height="{}" stroke="{}" fill="{}" stroke-width="{}" style="{}" />
""".format(
            self.indent,
